...
var playState = function(game){
    ...
    this.isButtonleftBtnPressed = false;
    this.isMobile = false;
};
    ...
    playState.prototype = {
          ...
          this.gameScore.create();
           ...
           /* this.pauseButton = this.game.add.button(25,25,'pauseBtn',this.handlePause,this);
            ...
            if (!game.device.desktop) {
                this.leftBtn = game.add.button(50, game.height-100, 'left', null, this, 0, 1, 0, 1);
                this.leftBtn.anchor.setTo(0.5,0.5);
                this.leftBtn.scale.setTo(0.4,0.4);
                this.leftBtn.fixedToCamera = true;

                this.rightBtn = game.add.button(game.width-50, game.height-100, 'right', null, this, 0, 1, 0, 1);
                this.rightBtn.anchor.setTo(0.5,0.5);
                this.rightBtn.scale.setTo(0.4,0.4);
                this.rightBtn.fixedToCamera = true;


                this.leftBtn.events.onInputDown.add(function() {
                    this.isButtonleftBtnPressed = true;
                }, this);

                this.leftBtn.events.onInputUp.add(function() {
                    this.isButtonleftBtnPressed = false;
                }, this);

                this.rightBtn.events.onInputDown.add(function() {
                    this.isButtonrightBtnPressed = true;
                }, this);

                this.rightBtn.events.onInputUp.add(function() {
                    this.isButtonrightBtnPressed = false;
                }, this);
        ...
        update: function(){
           ...
           if (this.isMobile) {
                if (this.isButtonleftBtnPressed) {
                    this.jolly.player.frame = 4;
                    this.jolly.player.body.velocity.x = -150;
                }else if (this.isButtonrightBtnPressed) {
                    this.jolly.player.frame = 4;   
                    this.jolly.player.body.velocity.x = 150;
                }else{
                    this.jolly.player.frame = 1;
                    this.jolly.player.body.velocity.x = 0;
                }
            } 

            this.jolly.handleMovement(this.isMobile);
            ...
            /*this.leftBtn.events.onInputDown.add(function() {
                this.jolly.player.frame = 4;
                this.jolly.player.body.velocity.x = -3500;
            }, this);
            this.leftBtn.events.onInputUp.add(function() {
                this.jolly.player.frame = 1;
                this.jolly.player.body.velocity.x = 0;
